...
CharactersResponseModel - возвращаемая сущность запроса. 
  ...
  Поиск работает без использования фильтра и производится только по имени. По сути отрабатывает метод фильтра с параметром name. Поиск сбрасывается, когда открываем фильтр. 
