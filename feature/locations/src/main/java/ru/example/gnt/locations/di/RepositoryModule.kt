...
import ru.example.gnt.locations.data.repository.LocationDetailsRepositoryImpl
...
internal abstract class RepositoryModule {
    ...
    @Binds
    internal abstract fun bindLocationDetailsRepository(repository: LocationDetailsRepositoryImpl): LocationDetailsRepository
