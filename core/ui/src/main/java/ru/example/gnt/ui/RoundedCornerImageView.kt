...
class RoundedCornerImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        val a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundedCornerImageView, 0, 0)
        val cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedCornerImageView_cornerRadius, 0)
        val roundedCorners = a.getInt(R.styleable.RoundedCornerImageView_roundedCorners, ALL_ROUNDED_CORNERS_VALUE)
        reverseMask = a.getBoolean(R.styleable.RoundedCornerImageView_reverseMask, reverseMask)
        a.recycle()
        init()
    ...
    constructor(context: Context, attrs: AttributeSet, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        val a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundedCornerImageView, defStyleAttr, 0)
        val cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedCornerImageView_cornerRadius, 0)
        val roundedCorners = a.getInt(R.styleable.RoundedCornerImageView_roundedCorners, ALL_ROUNDED_CORNERS_VALUE)
        reverseMask = a.getBoolean(R.styleable.RoundedCornerImageView_reverseMask, reverseMask)
        a.recycle()
